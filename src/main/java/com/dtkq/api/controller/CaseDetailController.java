...
public class CaseDetailController {
     ...
     */
    @Resource
    private CaseDetailService service;
    //    返回utils
    ...
    public Map<String, Object> findAll(@RequestBody CaseDetail entity) {
        ...
        List<CaseDetail> list =service.queryAll(entity);
    ...
    public Map<String, Object> addObj(@RequestBody CaseDetail entity) {
    ...
    public Map<String, Object> updateObj(@RequestBody CaseDetail entity) {
        if (entity.getId() != null) {
    ...
    public Map<String, Object> delObj(@RequestBody CaseDetail entity) {
        if (entity.getId() != null) {
    ...
    public Map<String, Object> findObj(@RequestBody CaseDetail entity) {
        if (entity.getId() != null) {
            CaseDetail obj=service.queryById(entity.getId());
            if(obj!=null){
